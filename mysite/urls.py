...
urlpatterns = [
    ...
    url(r'^login/$', auth_views.LoginView.as_view(template_name='mysite/login.html'), name='login'),
    ...
    url(r'^settings/password/$', auth_views.PasswordChangeView.as_view(template_name='mysite/password_change.html'),
    name='password_change'),
    url(r'^settings/password/done/$', auth_views.PasswordChangeDoneView.as_view(template_name='mysite/password_change_done.html'),
        name='password_change_done'),

    url(r'^reset/$',
    auth_views.PasswordResetView.as_view(
        template_name='mysite/password_reset.html',
        email_template_name='mysite/password_reset_email.html',
        subject_template_name='mysite/password_reset_subject.txt'
    ),
    name='password_reset'),
    url(r'^reset/done/$',
